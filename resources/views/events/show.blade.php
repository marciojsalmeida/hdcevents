 ...
 <div class="col-md-10 offset-md-1">
     <div class="row">
         ...
         <div id="info-container" class="col-md-6">
            <h1>{{ $event->title }}</h1>
            <p class="event-date"><ion-icon name="calendar-number-outline"></ion-icon> {{ date('d/m/Y', strtotime($event->date)) }}</p>
            ...
            @else
                 <p class="already-joined-msg">Você já está participando desse envento!</p>   
            @endif
